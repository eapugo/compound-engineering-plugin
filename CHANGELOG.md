...
## [2.47.0](https://github.com/eapugo/compound-engineering-plugin/compare/cli-v2.46.0...cli-v2.47.0) (2026-03-20)
...
* add cursor-marketplace as release-please component ([#315](https://github.com/eapugo/compound-engineering-plugin/issues/315)) ([838aeb7](https://github.com/eapugo/compound-engineering-plugin/commit/838aeb79d069b57a80d15ff61d83913919b81aef))
...
* **ci:** add npm registry auth to release publish job ([#319](https://github.com/eapugo/compound-engineering-plugin/issues/319)) ([3361a38](https://github.com/eapugo/compound-engineering-plugin/commit/3361a38108991237de51050283e781be847c6bd3))
* enable release-please labeling so it can find its own PRs ([a7d6e3f](https://github.com/eapugo/compound-engineering-plugin/commit/a7d6e3fbba862d4e8b4e1a0510f0776e9e274b89))
...
* make GitHub releases canonical for release-please ([#295](https://github.com/eapugo/compound-engineering-plugin/issues/295)) ([78971c9](https://github.com/eapugo/compound-engineering-plugin/commit/78971c902771f53fcacaae09b7630e2a07e417fb))
...
* prevent stale release PR body by closing before regeneration ([9de830a](https://github.com/eapugo/compound-engineering-plugin/commit/9de830aa5b5458b7936aff54909fe8fddf475831))
* re-enable changelogs so release PRs accumulate correctly ([516bcc1](https://github.com/eapugo/compound-engineering-plugin/commit/516bcc1dc4bf4e4756ae08775806494f5b43968a))
* reduce release-please search depth from 500 to 50 ([f1713b9](https://github.com/eapugo/compound-engineering-plugin/commit/f1713b9dcd0deddc2485e8cf0594266232bf0019))
* remove close-stale-PR step that broke release creation ([178d6ec](https://github.com/eapugo/compound-engineering-plugin/commit/178d6ec282512eaee71ab66d45832d22d75353ec))
* remove plugin versions from marketplace.json and fix brittle test ([4952007](https://github.com/eapugo/compound-engineering-plugin/commit/4952007cab4e3394ebe0bb23996c8a249d9bae2e))
...
* skip validate and stale-close on release PR merges ([6af241e](https://github.com/eapugo/compound-engineering-plugin/commit/6af241e9b5ce74a173e2c32c77944a42b6d9c4fd))
